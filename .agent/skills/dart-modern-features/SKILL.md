...
description: |-
  Modern Dart 3.x language features for idiomatic, concise, and safe code.
  Use when writing or reviewing Dart code targeting Dart 3.0 or later,
  refactoring legacy Dart code, or looking for idiomatic ways to handle
  multiple return values, deep data extraction, or exhaustive checking.
license: Apache-2.0
---
...
## Related Skills
- **[`dart-test-fundamentals`](../dart-test-fundamentals/SKILL.md)**: Use when structuring tests.
- **[`dart-package-maintenance`](../dart-package-maintenance/SKILL.md)**: Use when maintaining packages.
